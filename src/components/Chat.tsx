          ...
          {messages.map((msg) => {
            ...
            return (
              ...
              >
                {isSenderMe ? (
                  <>
                    <div className="px-3 py-2 rounded-xl flex rounded-tr-none bg-[#134d37]">
                      <p>{msg.text}</p>
                      <p className="text-sm self-end pl-2 pr-1 text-[#8caa9e]">
                        {msg.time}
                      </p>
                      <svg
                        viewBox="0 0 16 11"
                  ...
                  <>
                    ...
                    <div className="px-3 py-2 rounded-xl flex rounded-tl-none bg-[#1f272a]">
                      <p>{msg.text}</p>
                      <p className="text-sm self-end pl-2 text-[#909398]">
                        {msg.time}
                      </p>
                    </div>
                  </>
